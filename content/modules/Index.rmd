...
* 30% (Decrease to 20%) - Portfolio of work from completing session [homework](/homework/)
* 70% (Increase to 80%) - Fully reproducible project report
...
{{% alert instruction %}}
Create an account on the [vis-for-gds Slack](). Be sue to register with you `.leeds.ac.uk` e-mail. If you run into any problems, try [getting started with Slack](https://slack.com/intl/en-gb/help/articles/218080037-Getting-started-for-new-members).
{{% /alert  %}}
